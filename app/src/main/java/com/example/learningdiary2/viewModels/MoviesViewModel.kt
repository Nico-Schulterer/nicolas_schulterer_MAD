package com.example.learningdiary2.viewModels
...
class MoviesViewModel constructor(movieRepo: MovieRepo): ViewModel() {

    private val _movieRepository = movieRepo
    ...
    private val _favoriteMovieList = getFavoriteMovies().toMutableStateList()
